#Changes 
* Add [primeng](https://www.primefaces.org/primeng/#/) ui 
* Add sp-pnp-js 
* Default to "typescript": "2.4.0" the most stable typescipt at that moment.


# clone our repo
$ git clone https://github.com/irom/angularApp.git  angularApp
...
[MIT](/LICENSE)
"# angularApp"  git init git add README.md git commit -m "first commit" git remote add origin https://github.com/irom/angularApp.git git push -u origin master
